...
> Fill this section when initializing the brain for a new project.

```
Project Name   : [NAME]
Description    : [What it does in 2 sentences]
Tech Stack     : [Frontend / Backend / DB / Infra]
Current Phase  : [Planning / MVP / Active Dev / Maintenance]
Key Goals      : [Top 3 things this project must achieve]
Known Issues   : [Any active bugs or blockers]
Repo / Docs    : [Links if any]
```
